...
const PotterDashboard = () => {

  const { pToken, dashData, setDashData, getDashData ,completeAppointment,cancelAppointment } = useContext(PotterContext)
...
export default PotterDashboard