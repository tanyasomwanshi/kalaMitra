...
const AllSessions = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border border-gray-300 rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll focus:outline-none focus:ring-2 focus:ring-gray-200 '>
        ...
        {appointments.map((item, index) => (
          <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b border-gray-300 hover:bg-gray-50' key={index}>
            ...
            <div className='flex items-center gap-2'>
              <img className='w-8 rounded-full' src={item.potData.image} alt="" /> <p>{item.potData.name}</p>
            </div>
